...
#SBATCH --job-name=ucf_gzsl_od_dual_free_600
...
#SBATCH --output=res_dual_ucf101_gzsl_od_dual_free_600_sp_28_30.out
...
echo "GZSL OD: Dual GAN with FREE for for UCF101 (multi-GPU)"
